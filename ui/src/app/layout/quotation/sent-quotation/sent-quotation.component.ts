...
@Component({
  selector: 'app-sent-quotation',
  templateUrl: './sent-quotation.component.html',
  styleUrls: ['./sent-quotation.component.scss'],
  animations: [routerTransition()],
})
export class SentQuotationComponent extends DefaultListComponent<Order, OrderService> implements OnInit {
  private _searchTerm = '';
  lang: string;
  checkInput: boolean;
  modalRef: BsModalRef;
